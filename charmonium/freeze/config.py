...
from typing import Optional, Set, Tuple, Any, Hashable, Dict
import pathlib
...
class Config:
    ...
    ignore_nonlocals: Set[Tuple[str, str]] = field(default_factory=lambda: {
    ...
    ignore_files: Set[pathlib.Path] = field(default_factory=lambda: {
        # add the stdlib
    ...
    special_class_attributes: Set[str] = field(default_factory=lambda: {
        "__orig_bases__",
        "__dict__",
        "__weakref__",
        "__doc__",
